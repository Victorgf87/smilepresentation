        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
          ...
          <nav>
            <ul class="hs_menu collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <li><a href="negocios.php">NEGOCIOS</a>
                <ul>
                  <li><a>Descripci&oacute;n</a>
                  <li><a>Productos y equipos</a>
                  <li><a>&iquest;Quieres vender WSS?</a>
                  <li><a>Instrucciones de uso</a>
                  <li><a>Free Demo</a>
                  <li><a>FAQ</a>
                </ul>
              </li>
              <li><a href="domesticos.php">DOM&eacute;STICOS</a>
                <ul>
                  <li><a>Descripci&oacute;n</a>
                  <li><a>Ventajas</a>
                  <li><a>Instrucciones de uso</a>
...
function showFooterLinks()
{
  ...
  <div class="container">
    <div class="row">
      <h2>Donde puedes encontrar White Smile Secret</h2>
    </div>
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-3"><div class="divgrisfooter">logo + Link :a www.cliente1.com</div></div>
      <div class="col-lg-3 col-md-3 col-sm-3"><div class="divgrisfooter">logo + Link :a www.cliente1.com</div></div>
      <div class="col-lg-3 col-md-3 col-sm-3"><div class="divgrisfooter">logo + Link :a www.cliente1.com</div></div>
      <div class="col-lg-3 col-md-3 col-sm-3"><div class="divgrisfooter">logo + Link :a www.cliente1.com</div></div>
