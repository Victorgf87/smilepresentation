...
(function ($, window, document) {
    var Carousel = {
        ...
        updatePagination: function () {
            ...
            for (i = 0; i < base.itemsAmount; i += 1) if (i % base.options.items === 0) {
                counter += 1;
        ...
        checkNavigation: function () {
            ...
            if (base.options.rewindNav === false) if (base.currentItem === 0 && base.maximumItem === 0) {
        ...
        next: function (speed) {
            ...
            if (base.currentItem > base.maximumItem + (base.options.scrollPerPage === true ? base.options.items - 1 : 0)) if (base.options.rewindNav === true) {
                base.currentItem = 0;
                speed = "rewind"
            } else {
        ...
        prev: function (speed) {
            ...
            if (base.currentItem < 0) if (base.options.rewindNav === true) {
                base.currentItem = base.maximumItem;
                speed = "rewind"
            } else {
                base.currentItem = 0;
        ...
        gestures: function () {
            ...
            function getTouches(event) {
                if (event.touches !== undefined) return {
        ...
        closestItem: function () {
            ...
            $.each(array, function (i, v) {
                ...
                } else if (goal + base.itemWidth / 20 < v && goal + base.itemWidth / 20 > (array[i + 1] || array[i] - base.itemWidth) && base.moveDirection() === "right") if (base.options.scrollPerPage === true) {
        ...
        autoHeight: function () {
            ...
            function addHeight() {
                ...
                if (!base.wrapperOuter.hasClass("autoHeight")) window.setTimeout(function () {
