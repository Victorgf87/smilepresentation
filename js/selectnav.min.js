window.selectnav = function () {
    var e = function (e, t) {
            ...
            function d(e) {
                ...
                for (var v = 0; v < t; v++) {
                    ...
                    if (typeof m !== "undefined") {
                        ...
                        var y = "";
                        if (r) y = m.className.search(r) !== -1 || m.parentNode.className.search(r) !== -1 ? f : "";
                ...
                if (a === 1) n = '<select class="selectnav" id="' + p(true) + '">' + n + "</select>";
                a--;
                return n
            }
            ...
            if (l.addEventListener) l.addEventListener("change", c);
