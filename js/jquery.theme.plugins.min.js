...
(function (e, t) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeOutBounce: function (e, t, n, r, i) {
            ...
            else if (t < 2 / 2.75) return r * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + n;
            else if (t < 2.5 / 2.75) return r * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + n;
            else return r * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + n
        },
    ...
    e.fn.swipe = function (t) {
        ...
        return this.each(function () {
            ...
            function N(e, t) {
                ...
                if (t == v) if (n.click && (P == 1 || !m) && (isNaN(distance) || distance == 0)) n.click.call(_, e, e.target);
                if (t == d) {
            ...
            function L(e) {
                ...
                if (n.triggerOnTouchEnd) {
                    E = d;
                    if ((P == n.fingers || !m) && B.x != 0) if (distance >= n.threshold) {
                        N(e, E);
                        C(e)
                    } else {
                        E = v;
            ...
            function A(e) {
                ...
                if (P == n.fingers || !m) {
                    ...
                    if (!n.triggerOnTouchEnd) if (distance >= n.threshold) {
                        E = d;
                        N(e, E);
                        C(e)
                    }
